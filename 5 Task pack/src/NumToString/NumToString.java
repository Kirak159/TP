    ...
    public static String numToRus(String num) {
        ...
        if (num.length() == 3) {
            ...
            switch (Character.toString(num.charAt(0))) {
                case "1" : res += "Сто";
                case "2" : res += "Двести";
                case "3": res += map.get(Character.toString(num.charAt(0)) +    "ста");
                case "4" : res += map.get(Character.toString(num.charAt(0)) +    "ста");
            ...
            if (map.get(num.substring(1)) != null) {
                ...
                switch (Character.toString(num.charAt(1))) {
                    case "2" : res += " " + map.get(Character.toString(num.charAt(1))) + "дцать";
                    case "3" : res += " " + map.get(Character.toString(num.charAt(1))) + "дцать";
            ...
            if (map.get(num) != null) {
                ...
                switch (Character.toString(num.charAt(0))) {
                    case "2" : res += map.get(Character.toString(num.charAt(0))) + "дцать";
                    case "3" : res += map.get(Character.toString(num.charAt(0))) + "дцать";
            ...
            switch (Character.toString(num.charAt(0))) {
                ...
                default : res += map.get(Character.toString(num.charAt(0))) + "РґРµСЃСЏС‚"
                        + map.get(Character.toString(num.charAt(1)));
            }
        } else if (num.length() == 1) {
            res = map.get(num);
